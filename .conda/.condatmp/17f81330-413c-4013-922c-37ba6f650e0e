...
# installed.
TCL_PREFIX='s:/SEMESTER 3/AI(Lab)/Task/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='s:/SEMESTER 3/AI(Lab)/Task/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='s:/SEMESTER 3/AI(Lab)/Task/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Is:/SEMESTER 3/AI(Lab)/Task/.conda\Library\include'
...
TCL_PACKAGE_PATH='s:/SEMESTER 3/AI(Lab)/Task/.conda\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Ls:/SEMESTER 3/AI(Lab)/Task/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='s:/SEMESTER 3/AI(Lab)/Task/.conda\Library\lib\tclstub86.lib'
